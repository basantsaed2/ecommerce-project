...
export default function ProductsSection({ searchQuery = "" }: ProductsSectionProps) {
    ...
    return (
        <section className="w-full px-2 md:px-6 py-6 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                ...
                <Link href="/categories" className="group flex items-center gap-3 bg-white border border-gray-100 px-6 py-3 rounded-2xl text-sm font-black text-primary hover:border-secondary hover:text-secondary shadow-sm hover:shadow-lg transition-all active:scale-95 shrink-0">
